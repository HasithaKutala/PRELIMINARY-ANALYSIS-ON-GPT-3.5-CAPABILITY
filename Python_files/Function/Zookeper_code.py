...
class OpenAIModeling:
    ...
    def __init__(self, input_data):
        ...
        openai.api_key = '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'  # Placeholder for the API key

    def analyze_comments(self):
        input_text_column = self.input_data['comments']
        ...
        for input_text, category, sentiment in zip(eval_text, eval_category, eval_sentiment):
            try:
                ...
                # Save the results after processing each comment
                df_output.to_csv('Zookeeper_gpt3_response.csv', index=False)

                processed_comments_count += 1  # Increment the counter after a comment is processed
